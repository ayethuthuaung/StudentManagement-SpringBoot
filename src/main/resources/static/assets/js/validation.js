document.addEventListener("DOMContentLoaded", function() {
    ...
    function validateNullOrEmpty(inputValue) {
...
var isCourseNameValid = !validateNullOrEmpty(courseNameInput);

if (isCourseNameValid) {
    // Course name is not null or empty
    console.log("Course name is not null or empty.");
} else {
    // Course name is null or empty
    console.log("Course name is null or empty.");
}

    //Add Course
    document.getElementById("coursePriceInput").addEventListener("input", function() {
